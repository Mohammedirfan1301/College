...
int main(int argc, int argv[])
{
	...
	do{
		...
		printf("Welcome to the Rock, Paper, Scrissors Program \n");
		printf("This program lets two players play a game of Rock, Paper, Scrissors. \n");
		printf("Please use p/P for Paper, r/R for Rock and s/S for Sissors. \n\n");
