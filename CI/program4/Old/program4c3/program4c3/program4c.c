...
void us_to_metric_input(int* ft, double* in)
{
	...
	printf("Enter the numbers here (separated by spaces/enter): ");
	scanf("%d %lf", ft, in);
...
void us_to_metric_convert(int feet, double inches, int *meters, double *centimeters)
{
	//Convert feet/inches to meters/centimeters. Do this by multiplying feet/inches by conversion factors.
	//Using pointers to change the value of the meters/centimeters variables.
	*meters = feet * meters_to_feet;
	*centimeters = inches * inches_in_foot * meters_to_feet;
