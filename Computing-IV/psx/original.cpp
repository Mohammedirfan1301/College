...
Original::Original(int depth, int size) {
  ...
  // Create a new circle;
  _circle = new Original(_radius - 10, _depth - 1, size);
}


// Constructor with coordinates - recusive
Original::Original(float radius, int depth, int size) {
...
void Original::draw(sf::RenderTarget& target, sf::RenderStates states) const {
  ...
  shape.setPosition(_size/2, _size/2);
