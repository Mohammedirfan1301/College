...
// For some reason, making a vector of a vector wouldn't work without it in
// The generic_vector file....
GENERIC_VECTOR make_vector_of_mystring(void);	// Makes a vector of mystring

// Initializes vector of vector with 29 vectors of mystring
GENERIC_VECTOR vector_of_vector_init_default(GENERIC_VECTOR hVectofVect);	

// Initialize function
GENERIC_VECTOR make_vector_of_vector(void);		// Makes vector of vector

// Assignment / Destroy functions
void myvector_assignment(void** hVectVect, void* hVectofStr);
void myvector_destroyer(void** hVector);

// Couple of declarations for dictionary.c
