...
void assign_vector_of_mystring(void** hVector, void* hString);
void destroy_mystring(void** hVector);

void assign_vector_of_vector(void** hVector, void* pVector);
void destroy_hVector(void** hVector);
...
GENERIC_VECTOR make_vector_of_mystring(void)
{
	...
	functions.assignment = &assign_vector_of_mystring;
	functions.destructor = &destroy_mystring;
...
void destroy_mystring(void** pString)
{
	mystring_destroy((MYSTRING*)&pString);
	return;
}
