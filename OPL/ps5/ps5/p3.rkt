...
;;; Problem 3: Exercise 2.78
;;;  Modify the definitions of type-tag,
;;;  contents, and attach-tag from section 2.4.2 so that our generic
;;;  system takes advantage of Scheme's internal type system.  That is
;;;  to say, the system should work as before except that ordinary
