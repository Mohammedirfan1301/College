...
int CheckGuess(char letter, GENERIC_VECTOR* word_list, MYSTRING* guessed_string);
...
/*	**************************************************************************************
	...
	*************************************************************************************/
	for(i = guesses; i > 0; i--)
	{
		...
		won = CheckGuess(letter, &hVectofMystring, &guess_string)
...
/*	**************************************************************************************
	...
	*************************************************************************************/
	...
	else
	{
		...
		// To make it easy, I just grab the first MYSTRING off the generic_vector.
		ptr = (MYSTRING*)generic_vector_at(hVectofMystring, 0);
