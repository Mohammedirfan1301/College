...
struct node
{
	MYSTRING data;		// Each node contains a MYSTRING object.
	Node *left;		// The left / right nodes 
	Node *right;		
...
void in_order_traverse(Node* root, void (*visit)(MYSTRING);
void           destroy(Node* root);
void     	SearchTree(Node *head, MYSTRING item, Boolean *test);
int           FindSize(Node *temp, Node *numb);
Node*              Add(Node *head, Node *temp, Boolean *InSet, MYSTRING item);
Node*           Remove(Node *next, MYSTRING item, Boolean *InList);

//	Functions for TESTING
void      other_traverse(MY_SET hMY_SET, void (*visit)(MYSTRING));
void  pre_order_traverse(Node* root, void(*visit)(MYSTRING));
void post_order_traverse(Node* root, void(*visit)(MYSTRING));
