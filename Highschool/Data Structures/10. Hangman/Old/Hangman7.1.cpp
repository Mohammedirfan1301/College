...
void printword(int wordlen, char guess[], char input[], char real[]);				//Prints the word as it is guessed so far
...
void printword(int wordlen, char guess[], char input[], char real[])	//Prints the word as it has been guessed
{
    int a = 0;
