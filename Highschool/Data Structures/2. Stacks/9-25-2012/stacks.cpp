...
void file(int stack[])
{
    ...
    do{
        //the idea is right for push, but what about print/pop/peek? i cant just use ' '
        //b/c there is no ' '! that would break everything.
        //but the first command prints 'push' so it may work... and it does load the file
        // JUST MAKE SURE TO ADD THE .TXT!
