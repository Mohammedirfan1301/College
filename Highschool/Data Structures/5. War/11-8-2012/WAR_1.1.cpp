...
int turnwin(int deck1[52], int deck2[52], int bot1, int bot2);	//Used for checking which player has won the turn
...
void turn(int deck1[52], int deck2[52])
{
		...
		win = turnwin(deck1, deck2, bot1, bot2);	
...
int turnwin(int deck1[52], int deck2[52], int bot1, int bot2)
{
