...
void File(void);	//Handles file related stuff (takes in all the data)
...
{
	cout<<"SORTS V1.00 \n";
	File();	//Builds the list of numbers. Opens file, adds to a doubly list and closes the file when it sees "***";
	
	cout<<"\n\nWelcome to the SORTS program! \n";
	cout<<"Let's see if all the data got added to a doubly linked list! \n";
	Enter();
...
void File(void)
{
    ...
    do{
        ...
        {
			istringstream str(command);		//stream to take the number
