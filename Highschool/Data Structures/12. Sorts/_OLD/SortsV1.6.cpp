...
//===========================================================================================================================================================
	...
	//BUBBLE SORT
		...
		if(r == 1)
		{
			cout<<"BUBBLE SORT DIDN'T SORT RIGHT! ERROR ERROR ERROR! \n";
			times[0] = -1;
		}
		//Print(head);				//Beta testing purposes
	...
	//SELECTION SORT
		...
		if(r == 1)
		{
			cout<<"SELECTION SORT DIDN'T SORT RIGHT! ERROR ERROR ERROR! \n";
			times[1] = -1;
		}
		//Print(head);				//Beta testing purposes
		Destroy(head);				//Destroy the list so another blank, unsorted list can be created.
	...
	//MERGE SORT
		...
		if(r == 1)
		{
			cout<<"MERGE SORT DIDN'T SORT RIGHT! ERROR ERROR ERROR! \n";
			times[2] = -1;
		}
		//Print(head);				//Beta testing purposes
		Destroy(head);				//Destroy the list so another blank, unsorted list can be created.
	...
	//QUICK SORT
		...
		if(r == 1)
		{
			cout<<"QUICK SORT DIDN'T SORT RIGHT! ERROR ERROR ERROR! \n";
			times[3] = -1;
		}
		//Print(head);				//Beta testing purposes
		Destroy(head);				//Destroy the list so another blank, unsorted list can be created.
...
void SortReport(double times[])	//Reports how long each sorting element took
{
	...
	if(times[0] == -1 && times[2] == -1 && times[3] != -1)
	{
		times[0] = times[2];
		times[1] = times[3];
		times[2] = -1;
