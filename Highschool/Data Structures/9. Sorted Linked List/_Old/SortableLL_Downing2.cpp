...
{	
	...
	//This is the 'sortable' part. Each new node is added in a pre-sorted way. It is sorted into ascending order. least to greatest
	//		3 possible outcomes - less then, greater than or equal to
	//		also either head, somewhere in the middle or at the end
	//		1	2	3	4	5
	//		2	1
	//		1	1
	else
	{
		prev = *head;	//The list isn't empty - I will have to search for the last node.
		...
		else			//other wise search until you find where curr is less then the next node or prev -> next == null
		{
