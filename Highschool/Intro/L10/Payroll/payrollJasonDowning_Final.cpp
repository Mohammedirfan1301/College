...
main()
{
	int numemployee = 0, a = 0, b = 1, x = 1, y = 1;  //variables the # of employees, for loop (a), switch (b) and do whiles (x = main do/while y = final print out)
	int totalhours = 0, totalpay = 0;                 //variables for hours/pay - ALL employees that is.
