...
//float hourly(float, float);       //hourly employee function
...
int main()
{
	...
	float hours = 0, holidayhours = 0, otholidayhours = 0;  //variables for the functions (hour related)
...
//	clrscr();
    ...
    cout<<"You are the last employee to enter their information. Please let your \n";
...
/*
float hourly(float hours, float holiday)
{
    float 
