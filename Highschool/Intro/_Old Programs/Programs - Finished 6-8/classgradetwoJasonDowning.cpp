...
{                      //NOTE: > is greater than, < is less than.
	...
	float round;       //used for rounding of b.
	...
	do {
        ...
        //enter 66.9 -> change to 67
		//enter 66.8 -> change to 67
		//enter 66.7 -> change to 67
		//enter 66.6 -> change to 67
		//enter 66.5 -> change to 67 MUST ROUND UP from here
		//enter 66.4 -> change to 66 MUST ROUND DOWN from here
		//enter 66.3 -> change to 66
		//enter 66.2 -> change to 66
		//enter 66.1 -> change to 66
		
		
        round = b - floor(b);  // this basically says 'round is equal to (b - the floor of b)
                               //example 1: 66.6 - 66 = .6
                               //example 2: 66.5 - 66 = .5
                               //example 3: 66.4 - 66 = .4
		
        if (round >= .5)       // this compares round and whether it is greater than .5. So example 1 and 2 would work while 3 would not.               
		{
            b = ceil(b);       //ceil rounds up, so 66.6 and 66.5 become 67  
        }
        
        else                   // the else is used for all the lower numbers, under .5 (ie .49 and lower)    
        {
            b = floor(b);      //floor rounds down, so 66.4 becomes 66
        }
