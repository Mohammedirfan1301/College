...
main()
{
      ...
      while(num==1)
      {
		...
		cout<<endl<<"\nThank You for using the Decimal to Binary Convertor. ";      //ending prompt which lets the user know the program has ended.
