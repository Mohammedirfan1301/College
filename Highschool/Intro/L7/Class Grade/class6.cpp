...
main()
{
	...
	int counter = 0;   //sum of the numbers entered.
	int counter2 = 0;  //number of times the loop ran.
	...
	cout<<"3. Running Class Average (for Numerical to Letter) \n";
	cout<<endl;
	...
	while(a==1)  //if a==1, then the number grade part start.
	{
		...
		cout<<endl;
		cout<<"The sum of the loop is "<<counter<<" \n"; 	  //sum of the grades entered.
		cout<<"The loop ran "<<counter2<<" times \n";  		  //number of times the program ran.
