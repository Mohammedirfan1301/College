...
main()
{
	...
	{   
        ...
        cout<<endl;
		cout<<"Enter 1 to continue or 0 exit. -> ";         //lets the user continue or exit the program.
		cin>>num;
		cout<<endl;
	}

	cout<<endl;
	cout<<"Thank you for using the Multi-Loop Program.";	//lets user know the program ended.
