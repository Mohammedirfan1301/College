...
\noindent
In certain programming languages, comments appear between delimiters such			\\
as /\# and \#/. Let C be the language of all valid delimited comment strings. 		\\
A member of C must begin with /\# and end with \#/ but have no intervening  		\\
\#/. For simplicity, assume that the alphabet for C is $\sum$ = \{a, b, /, \#\}.	\\
