...
\noindent
b. \\
% The complement of the language {a^nb^n| n >= 0}
The language is: \\
...
\noindent
d. \\
% {x1#x2# · · · #xk| k  1, each xi 2 {a, b}*, and for some i and j, xi = xRj}
The language is: \\
...
This one will end up being super annoying. \\
...
This one might be annoying, we will have to figure it out later. \\
