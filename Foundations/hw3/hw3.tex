...
\begin{center}
	...
	\draw [black] (47.1,-29.9) circle (3);
	\draw (47.1,-29.9) node {$q2$};
	\draw [black] (47.1,-29.9) circle (2.4);
	\draw [black] (15.4,-29.9) -- (27.1,-29.9);
	\fill [black] (27.1,-29.9) -- (26.3,-29.4) -- (26.3,-30.4);
	\draw (21.25,-30.4) node [below] 
	\draw [black] (33.1,-29.9) -- (44.1,-29.9);
	\fill [black] (44.1,-29.9) -- (43.3,-29.4) -- (43.3,-30.4);
	\draw (38.6,-30.4) node [below] [text width=2cm,align=center] {$0, 0\mbox{ }\rightarrow\mbox{ }\epsilon$\\$1, 1\mbox{ } \rightarrow\mbox{ } \epsilon$};
	\draw [black] (28.777,-27.22) arc (234:-54:2.25);
	\draw (30.1,-22.65) node [above] [text width=2cm,align=center] {$0, \epsilon \rightarrow \epsilon$\\
	$1, \epsilon \rightarrow \epsilon$};
	\fill [black] (31.42,-27.22) -- (32.3,-26.87) -- (31.49,-26.28);
	\draw [black] (3.9,-29.9) -- (9.4,-29.9);
	\fill [black] (9.4,-29.9) -- (8.6,-29.4) -- (8.6,-30.4);
	
	\draw [black] (15.4,-29.9) [bend right] (44.1,-29.9);
	\fill [black] (44.1,-29.9) [bend right] (43.3,-29.4) [bend right](43.3,-30.4);
	\draw (29.75,-30.4) node [bend right] {$hi$};
	
	\draw (21.25,-30.4) node [below] [text width=2cm,align=center] {$1,\epsilon\mbox{ }\rightarrow\mbox{ }1$\\$0\epsilon\mbox{ } \rightarrow\mbox{ }0$};
	\end{tikzpicture}
\end{center}
...
\begin{center}
    ...
    % Paths
    \path [->] 	(q1) edge 	node	[text width=2cm,align=center] {$1,\epsilon \rightarrow 1$ \\ $0 \epsilon \rightarrow 0$};	(q2);
...
that means no string is accepted by the CFG including the empty string.
